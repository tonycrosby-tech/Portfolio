...
export default function Navbar() {
  return (
    <div class="mx-auto">
      <nav class="flex items-center justify-between flex-wrap bg-gray-100 p-10">
        <div class="flex items-center flex-shrink-0 text-white mr-6">
          ...
          <span class=" text-xl tracking-tight font-bold text-black mx-2">Tony Crosby</span>
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap items-center text-base justify-center">
          <a href="#projects" className="mr-5 text-gray-900 font-mono hover:text-blue-500">
            Past Work
          </a>
        ...
        <a
          href="#contact"
          className="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 hover:text-blue-500 rounded text-base mt-4 md:mt-0">
          Hire Me
