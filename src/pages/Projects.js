    ...
    <section id="projects" className="text-gray-400 bg-blue-700 body-font">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <h1 className="sm:text-4xl text-3xl font-bold font-serif title-font mb-4 text-white">
            Projects
          </h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed italic font-mono text-white text-base">
